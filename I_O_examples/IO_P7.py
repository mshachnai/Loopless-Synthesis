# P7 - Isolate right-most 0-bit - using i/o examples
...
spec = z3.And(z3.Implies(I == -3, O == 2),
        z3.Implies(I == 2, O == 1),
        #z3.Implies(I == 5, O == 2)
        #z3.Implies(I == 13, O == 2)
        #z3.Implies(I == -1, O == -1),
...
# One example is enough to get a correct result, but not the wanted spec. 3 instructions 
# require at least two good i/o examples to give the wanted spec.
# For example:
#(I == 5, O == 2)
#(I == 2, O == 1)
#   will give the right spec together, where
#(I == 14, O == 1)
#(I == 2, O == 1)
#   will not
# No example makes this unsat/unknown. 
