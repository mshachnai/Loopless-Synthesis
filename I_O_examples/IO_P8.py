# P8 - Form mask that identifies trailing 0s -- I/O examples
...
spec = z3.And(#z3.Implies(I == 12, O == 3),
        z3.Implies(I == 2, O == 1),
        #z3.Implies(I == 5, O == 2)
        #z3.Implies(I == 13, O == 2)
        #z3.Implies(I == -1, O == -1),
...
# One good example (one of the first two here) is enough to get a correct result, and the wanted spec. 
