...
for t in range(8) :
    ...
    output_component = (O == z3.BitVecVal((2**(t+1))-1, 8))
...
#The case when I = 0 then O should be all 1s.
#spec_list.append(z3.Implies(I == z3.BitVecVal(0, 8), O == z3.BitVecVal(255, 8)))


spec = z3.And(spec_list)

# phi cons = line number of two different instructions cannot be the same
phicons = z3.And(ly1 != ly2)
